...
createTrackbar( "Hue",window_name, &H, MAX_H, onTrackbar_changed );
createTrackbar( "Saturation",window_name, &S, MAX_S,onTrackbar_changed );
createTrackbar( "Value",window_name, &V, MAX_V,onTrackbar_changed);
